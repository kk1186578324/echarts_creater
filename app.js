function getOptions(e) {
    function a(e) {
        for (var a, t = ["北京", "天津", "河北", "河北", "山西", "内蒙古", "辽宁", "吉林", "黑龙江", "上海", "江苏"], l = 2002; 2007 >= l; l++) {
            var r = 0
                , o = 0;
            a = e[l];
            ...
            e[l + "max"] = 100 * Math.floor(r / 100),
                e[l + "sum"] = o
        }
        return e
    }
    var t = e ? e.theme.seriesCnt : 4
        , l = ["周一", "周二", "周三", "周四", "周五", "周六", "周日"]
        , r = l.length
        , o = function() {
        for (var e = [], a = 0; t > a; ++a)
            e.push("第" + (a + 1) + "组");
        ...
        for (var o = 0; t > o; ++o) {
            for (var n = [], i = 0; l > i; ++i) {
                if ("scatter" === e)
                    var m = [Math.floor((600 * Math.random() + 400) * (t - o) / t), Math.floor((600 * Math.random() + 400) * (t - o) / t)];
                else
                    var m = Math.floor((600 * Math.random() + 400) * (t - o) / t);
                n.push(m)
            }
            "radar" === e && (n = [n]),
                a.push({
                    ...
                    data: n,
                    name: "第" + (o + 1) + "组",
                    markPoint: "line" === e || "bar" === e || "scatter" === e ? {
                        data: [{
                            name: "最高",
                            type: "max"
                        }]
        ...
        for (var a = [], l = 0; t > l; ++l)
            a.push({
                name: n.data[l],
                value: Math.floor((800 * Math.random() + 200) * (t - l) / t)
            });
        return {
            type: e,
            data: a
    ...
    for (var b = [{
        ...
        options: [{
            ...
            series: [{
                ...
                data: [{
                    name: "第一产业",
                    value: h.dataPI["2002sum"]
                }, {
                    name: "第二产业",
                    value: h.dataSI["2002sum"]
                }, {
                    name: "第三产业",
                    value: h.dataTI["2002sum"]
                }]
            }]
        }, {
            title: {
            ...
            series: [{
                ...
                data: [{
                    name: "第一产业",
                    value: h.dataPI["2003sum"]
                }, {
                    name: "第二产业",
                    value: h.dataSI["2003sum"]
                }, {
                    name: "第三产业",
                    value: h.dataTI["2003sum"]
                }]
            }]
        }, {
            title: {
            ...
            series: [{
                ...
                data: [{
                    name: "第一产业",
                    value: h.dataPI["2004sum"]
                }, {
                    name: "第二产业",
                    value: h.dataSI["2004sum"]
                }, {
                    name: "第三产业",
                    value: h.dataTI["2004sum"]
                }]
            }]
        }, {
            title: {
            ...
            series: [{
                ...
                data: [{
                    name: "第一产业",
                    value: h.dataPI["2005sum"]
                }, {
                    name: "第二产业",
                    value: h.dataSI["2005sum"]
                }, {
                    name: "第三产业",
                    value: h.dataTI["2005sum"]
                }]
            }]
        }, {
            title: {
            ...
            series: [{
                ...
                data: [{
                    name: "第一产业",
                    value: h.dataPI["2006sum"]
                }, {
                    name: "第二产业",
                    value: h.dataSI["2006sum"]
                }, {
                    name: "第三产业",
                    value: h.dataTI["2006sum"]
                }]
            }]
        }, {
            title: {
            ...
            series: [{
                ...
                data: [{
                    name: "第一产业",
                    value: h.dataPI["2007sum"]
                }, {
                    name: "第二产业",
                    value: h.dataSI["2007sum"]
                }, {
                    name: "第三产业",
                    value: h.dataTI["2007sum"]
                }]
            }]
        }]
    }, {
        ...
        xAxis: {
            type: "category",
            data: ["12a", "1a", "2a", "3a", "4a", "5a", "6a", "7a", "8a", "9a", "10a", "11a", "12p"]
        },
        yAxis: {
            type: "category",
        ...
        series: [{
            ...
            data: function() {
                for (var e = [], a = 0; t > a; ++a) {
                    for (var l = [], r = 0, o = 0, n = Math.ceil(5 * Math.random()); n > o; ++o) {
                        for (var i = [], m = 0, s = 0, u = Math.ceil(3 * Math.random()); u > s; ++s) {
                            var d = Math.ceil(100 * Math.random());
                            i.push({
                                value: d,
                                name: a + 1 + "-" + (o + 1) + "-" + (s + 1),
                                path: a + 1 + "/" + (a + 1) + "-" + (o + 1) + "/" + (a + 1) + "-" + (o + 1) + "-" + (s + 1)
                            }),
                                m += d
                        }
                        l.push({
        ...
        b[y].legend = b[y].legend || n,
            b[y].tooltip = b[y].tooltip || c,
            b[y].grid = b[y].grid || g;
    return b
}
var VueColor = Vue.extend({
    template: '<div class="input-group colorpicker-component"><input type="text" class="form-control" debounce="2000" /><span class="input-group-addon"><i></i></span></div>',
    compiled: function() {
        var e = this
            , a = $(this.$el);
        a.find("input").val(this.color),
            a.colorpicker().on("changeColor", function() {
                var t = a.find("input").val()
                    , l = echarts.color.parse(t);
                l && e.$set("color", t)
            }),
            e.$watch("color", function(e) {
                a.colorpicker("setValue", e)
            })
    },
    props: {
        color: {
...
var VueColorList = Vue.extend({
    template: '<div><div v-for="color in colors" track-by="$index"><color :color.sync="color"></color></div><div class="theme-color-control"><a v-on:click="addColor()">增加</a><a v-on:click="removeColor()" v-show="colors.length > 1">减少</a></div></div>',
    props: {
        colors: {
            twoWay: !0
        }
...
var VueNumberConfig = Vue.extend({
    template: '<div class="form-group">  <div class="col-sm-3">    <input type="checkbox" v-model="enabled" v-if="canDisable" />    <label class="control-label">{{title}}</label>  </div>  <div class="col-sm-9">    <div class="input-group" v-show="enabled">      <input type="number" v-model="value" class="form-control" />    </div>  </div></div>',
    props: {
        title: String,
        canDisable: {
            type: Boolean,
...
var VueColorConfig = Vue.extend({
    template: '<div class="form-group">  <div class="col-sm-3">    <input type="checkbox" v-model="enabled" v-if="canDisable" />    <label class="control-label">{{title}}</label>  </div>  <div class="col-sm-9">    <color :color.sync="color" v-show="enabled"></color>  </div></div>',
    props: {
        title: String,
        canDisable: {
            type: Boolean,
...
var VueColorListConfig = Vue.extend({
    template: '<div class="form-group">  <div class="col-sm-3">    <input type="checkbox" v-model="enabled" v-if="canDisable" />    <label class="control-label">{{title}}</label>  </div>  <div class="col-sm-9">    <color-list :colors.sync="colors" v-show="enabled"></color-list>  </div></div>',
    props: {
        title: String,
        canDisable: {
            type: Boolean,
...
Vue.component("config-color-list", VueColorListConfig),
    function() {
        function e(e) {
            try {
                var a = JSON.parse(e);
                if (void 0 === a.themeName && void 0 === a.version)
                    return alert("请使用本网站“导出配置”的 JSON 文件，而不是下载的主题文件。"),
                        void 0;
                if (x.$set("themeName", a.themeName || "customed"),
                    a.version < b) {
                    var t = []
                        , l = a.theme;
                    for (var r in f)
                        "axis" !== r && ("undefined" != typeof a.theme[r] ? l.attr = a.theme[r] : t.push(a.theme.attr));
                    t.length > 0 ? alert("导入的主题版本较低，有" + t.length + "个属性未被设置，现已使用默认值。") : console.warn("导入的主题版本较低，可能有部分属性未生效。")
                }
                x.$set("theme", a.theme),
                    x.axisSeperateSettingChanges()
            } catch (o) {
        ...
        function a(e) {
            function a(e) {
                return x.theme.axisSeperateSetting || (e = 0),
                    {
                        axisLine: {
                            show: x.theme.axes[e].axisLineShow,
                            lineStyle: {
                                color: x.theme.axes[e].axisLineColor
                            }
                        },
                        axisTick: {
                            show: x.theme.axes[e].axisTickShow,
                            lineStyle: {
                                color: x.theme.axes[e].axisTickColor
                            }
                        },
                        axisLabel: {
                            show: x.theme.axes[e].axisLabelShow,
                            textStyle: {
                                color: x.theme.axes[e].axisLabelColor
                            }
                        },
                        splitLine: {
                            show: x.theme.axes[e].splitLineShow,
                            lineStyle: {
                                color: x.theme.axes[e].splitLineColor
                            }
                        },
                        splitArea: {
                            show: x.theme.axes[e].splitAreaShow,
                            areaStyle: {
                                color: x.theme.axes[e].splitAreaColor
                            }
                        }
                    }
            }
            var t = "path://M237.062,81.761L237.062,81.761c-12.144-14.24-25.701-20.1-40.68-19.072 c-10.843,0.747-20.938,5.154-30.257,13.127c-9.51-5.843-19.8-9.227-30.859-10.366c0.521-3.197,1.46-6.306,2.85-9.363 c3.458-7.038,8.907-12.741,16.331-17.296c-5.609-3.384-11.227-6.799-16.854-10.279c-16.257,8.104-25.06,20.601-26.463,38.417 c-7.599,1.705-14.685,4.486-21.247,8.437c-9.164-7.677-18.996-11.917-29.496-12.632c-14.819-0.998-28.467,4.787-40.938,18.827 C6.445,96.182,0,114.867,0,136.242c-0.007,6.371,0.674,12.646,2.053,18.738c4.593,22.785,15.398,41.367,32.558,55.344 c15.43,12.773,29.901,18.023,43.362,16.981c7.074-0.561,13.624-3.977,19.685-10.192c10.534,5.49,20.391,8.217,29.561,8.203 c9.856-0.012,20.236-2.953,31.125-8.898c6.227,6.692,12.966,10.346,20.211,10.933c13.795,1.073,28.614-4.111,44.377-16.84 c17.49-14.104,28.043-32.79,31.796-55.485c0.836-5.624,1.272-11.292,1.272-16.966C255.998,115.814,249.707,96.601,237.062,81.761z  M54.795,97.7l40.661,14.496c-4.402,8.811-10.766,13.219-19.06,13.219c-2.542,0-4.917-0.419-7.122-1.274 C58.103,118.38,53.263,109.572,54.795,97.7z M150.613,185.396l-9.156-8.389l-7.619,12.951c-3.391,0.341-6.615,0.514-9.665,0.514 c-4.401,0-8.635-0.263-12.708-0.777l-8.634-14.973l-9.151,9.909c-4.91-2.717-9.15-5.856-12.708-9.413 c-8.81-8.295-13.384-17.959-13.727-28.97c2.877,1.692,7.427,3.461,13.675,5.308l10.636,13.629l9.44-9.852 c4.734,0.702,9.234,1.12,13.466,1.275l10.689,11.498l9.671-11.949c3.559-0.173,7.285-0.515,11.182-1.01l9.924,10.159l10.933-14.227 c5.931-1.351,11.196-2.798,15.771-4.323C179.747,163.538,169.068,176.414,150.613,185.396z M175.258,124.907 c-2.209,0.849-4.66,1.273-7.369,1.273c-8.134,0-14.489-4.415-19.052-13.224l40.905-14.477 C191.105,110.331,186.273,119.141,175.258,124.907z"
                ...
                itemStyle: {
                    normal: {
                        borderWidth: x.theme.symbolBorderWidth
                    }
                },
                lineStyle: {
                    normal: {
                        width: x.theme.lineWidth
                    }
                },
                symbolSize: x.theme.symbolSize,
                symbol: x.theme.symbol,
                smooth: x.theme.lineSmooth
            }
                , r = {
                itemStyle: {
                    normal: {
                        borderWidth: x.theme.borderWidth,
                        borderColor: x.theme.borderColor
                    },
                    emphasis: {
                        borderWidth: x.theme.borderWidth,
                        borderColor: x.theme.borderColor
            ...
            "halloween" === x.themeName && (l.symbol = t,
                r.symbol = t);
            var o = {
                itemStyle: {
                    normal: {
                        areaColor: x.theme.mapAreaColor,
                        borderColor: x.theme.mapBorderColor,
                        borderWidth: x.theme.mapBorderWidth
                    },
                    emphasis: {
                        areaColor: x.theme.mapAreaColorE,
                        borderColor: x.theme.mapBorderColorE,
                        borderWidth: x.theme.mapBorderWidthE
                    }
                },
                label: {
                    normal: {
                        textStyle: {
                            color: x.theme.mapLabelColor
                        }
                    },
                    emphasis: {
                        textStyle: {
                            color: x.theme.mapLabelColorE
                        }
                    }
                }
            };
            return {
                color: x.theme.color,
                backgroundColor: e ? x.theme.backgroundColor : "transparent",
                textStyle: x.theme.textColorShow ? {
                    color: x.theme.textColor
                } : {},
                title: {
                    textStyle: {
                        color: x.theme.titleColor
                    },
                    subtextStyle: {
                        color: x.theme.subtitleColor
                    }
                },
                line: l,
                radar: l,
                bar: {
                    itemStyle: {
                        normal: {
                            barBorderWidth: x.theme.borderWidth,
                            barBorderColor: x.theme.borderColor
                        },
                        emphasis: {
                            barBorderWidth: x.theme.borderWidth,
                            barBorderColor: x.theme.borderColor
                ...
                candlestick: {
                    itemStyle: {
                        normal: {
                            color: x.theme.kColor,
                            color0: x.theme.kColor0,
                            borderColor: x.theme.kBorderColor,
                            borderColor0: x.theme.kBorderColor0,
                            borderWidth: x.theme.kBorderWidth
                        }
                    }
                },
                graph: function() {
                    var e = g(l);
                    return e.color = x.theme.color,
                        e.lineStyle = {
                            normal: {
                                width: x.theme.graphLineWidth,
                                color: x.theme.graphLineColor
                            }
                        },
                        e.label = {
                            normal: {
                                textStyle: {
                                    color: x.theme.markTextColor
                                }
                            }
                        },
                        e.itemStyle.normal.borderWidth = x.theme.borderWidth,
                        e.itemStyle.normal.borderColor = x.theme.borderColor,
                        e
                }(),
                map: o,
                geo: o,
                ...
                toolbox: {
                    iconStyle: {
                        normal: {
                            borderColor: x.theme.toolboxColor
                        },
                        emphasis: {
                            borderColor: x.theme.toolboxEmpasisColor
                        }
                    }
                },
                legend: {
                    textStyle: {
                        color: x.theme.legendTextColor
                    }
                },
                tooltip: {
                    axisPointer: {
                        lineStyle: {
                            color: x.theme.tooltipAxisColor,
                            width: x.theme.tooltipAxisWidth
                        },
                        crossStyle: {
                            color: x.theme.tooltipAxisColor,
                            width: x.theme.tooltipAxisWidth
                ...
                timeline: {
                    lineStyle: {
                        color: x.theme.timelineLineColor,
                        width: x.theme.timelineLineWidth
                    },
                    itemStyle: {
                        normal: {
                            color: x.theme.timelineItemColor,
                            borderWidth: x.theme.timelineItemBorderWidth
                        },
                        emphasis: {
                            color: x.theme.timelineItemColorE
                        }
                    },
                    controlStyle: {
                        normal: {
                            color: x.theme.timelineControlColor,
                            borderColor: x.theme.timelineControlBorderColor,
                            borderWidth: x.theme.timelineControlBorderWidth
                        },
                        emphasis: {
                            color: x.theme.timelineControlColor,
                            borderColor: x.theme.timelineControlBorderColor,
                    ...
                    checkpointStyle: {
                        color: x.theme.timelineCheckColor,
                        borderColor: x.theme.timelineCheckBorderColor
                    },
                    label: {
                        normal: {
                            textStyle: {
                                color: x.theme.timelineLabelColor
                            }
                        },
                        emphasis: {
                            textStyle: {
                ...
                visualMap: {
                    color: x.theme.visualMapColor
                },
                dataZoom: {
                    backgroundColor: x.theme.datazoomBackgroundColor,
                    dataBackgroundColor: x.theme.datazoomDataColor,
                    fillerColor: x.theme.datazoomFillColor,
                    handleColor: x.theme.datazoomHandleColor,
                    handleSize: x.theme.datazoomHandleWidth + "%",
                    textStyle: {
                        color: x.theme.datazoomLabelColor
                    }
                },
                markPoint: {
                    label: {
        ...
        function t(e, a, l) {
            var r = $(".ec-panel").eq(e);
            if (r.length) {
                var o = echarts.init(r[0], "customed");
                o.setOption(a[e]);
                var n = e + 1;
                n === $(".ec-panel").length && (n = 0),
                n !== l && (C = setTimeout(function() {
                    t(n, a, l)
                }, 150))
            }
        }
        function l() {
            if (!x.isPauseChartUpdating) {
                echarts.registerTheme("customed", a(!1));
                var e = getOptions(x);
                C && clearTimeout(C);
                for (var l = $(".ec-panel").length, r = !1, o = 0; l > o; ++o) {
                    var n = $(".ec-panel").eq(o);
                    if (n.offset().top + n.height() > 0) {
                        t(o, e, o),
                            r = !0;
                        break
                    }
                ...
                r || t(0, e),
                    x.chartDisplay.background = x.theme.backgroundColor,
                    x.chartDisplay.title = x.theme.titleColor
            }
        }
        function r(e, a) {
            var t = JSON.stringify(e, null, "    ");
            n(t, a, "json")
        }
        function o(e, a) {
            n(e, a, "js")
        ...
        function n(e, a, t) {
            if (i())
                window.open("data:text/plain;charset=utf-8," + encodeURIComponent(e));
            else
                try {
                    var l = new Blob([e],{
                        type: t
        ...
        function c(e) {
            ...
            if (window.getSelection) {
                ...
                t.selectNode($("#" + e + "-code")[0]);
                var l = window.getSelection();
                l.removeAllRanges(),
                    l.addRange(t)
            } else if (document.selection) {
                var t = document.body.createTextRange();
                t.moveToElementText($("#" + e + "-code")[0]),
                    t.select()
            }
            $(".code-btn label").hide(),
                m() || s() || !document.execCommand("copy") ? a("copy-" + e + "-fail") : (a("copy-" + e + "-success"),
        ...
        var b = 1
            ...
            theme: ["#ff715e", "#ffaf51", "#ffee51", "#797fba", "#715c87"]
        }]
            , f = {
            seriesCnt: 3,
            ...
            axes: function() {
                for (var e = ["all", "category", "value", "log", "time"], a = ["通用", "类目", "数值", "对数", "时间"], t = [], l = 0; l < e.length; ++l)
                    t.push({
                        type: e[l],
                        name: a[l] + "坐标轴",
                        axisLineShow: !0,
                        ...
                        axisLabelShow: !0,
                        axisLabelColor: "#333",
                        splitLineShow: "category" === e[l] ? !1 : !0,
                        splitLineColor: ["#ccc"],
                        splitAreaShow: !1,
        ...
        f.axis = [f.axes[0]];
        for (var v = _.debounce(l, 200), p = 0; p < y.length; ++p)
            h(p, !0);
        var x = new Vue({
            el: "#content",
            data: {
            ...
            methods: {
                updateCharts: l,
                updateSymbol: function(e) {
                    x.theme.symbol = e
                },
                selectPreDefinedTheme: function(a) {
                    for (var t = 0; t < x.loadedThemes.length; ++t)
                        if (x.loadedThemes[t].id === a)
                            return e(x.loadedThemes[t].data),
                                void 0;
                    h(a, !1)
                },
                useTheme: function() {
                    _hmt.push(["_trackEvent", "theme-builder", "useTheme", x.themeName]),
                        $("#js-code").text(d()),
                        $("#json-code").text(JSON.stringify(a(!0), null, "    ")),
                ...
                exportJson: function() {
                    ...
                    delete e.axis,
                        r({
                            ...
                            theme: e
                        }, (x.themeName || "customed") + ".project.json")
                },
                importJson: function() {
                    $("#input-file").trigger("click")
                },
                importFileChanged: function(a) {
                    if (a.target.files) {
                        var t = a.target.files[0]
                            , l = t.name.slice(t.name.lastIndexOf("."));
                        if (".json" !== l)
                            return alert("非法后缀！请使用本网站导出的 *.json 文件。"),
                                void 0;
                ...
                axisSeperateSettingChanges: function() {
                    x.theme.axis = x.theme.axisSeperateSetting ? x.theme.axes : [x.theme.axes[0]]
                }
            }
        });
        x.$watch("theme", v, {
